...
apt install -y  apache2 apr apr-util autoconf bison busybox clang coreutils git ruby ruby-dev nmap netcat openssh make php php-pgsql php-curl figlet ecj 
